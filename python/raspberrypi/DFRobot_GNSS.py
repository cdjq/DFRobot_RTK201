# -*- coding: utf-8 -*
'''!
  @file DFRobot_RTK201.py
  @brief DFRobot_RTK201 Class infrastructure, implementation of underlying methods
...
class DFRobot_RTK201_I2C(DFRobot_RTK201): 
  def __init__(self, bus, addr):
    self.__addr = addr
    super(DFRobot_RTK201_I2C, self).__init__(bus,0)
...
class DFRobot_RTK201_UART(DFRobot_RTK201):

  def __init__(self, Baud):
    self.__Baud = Baud
    super(DFRobot_RTK201_UART, self).__init__(0, Baud)
